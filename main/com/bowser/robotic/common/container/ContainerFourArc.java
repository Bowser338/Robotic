package com.bowser.robotic.common.container;
...
import com.bowser.robotic.common.FourArcRecipes;
import com.bowser.robotic.common.tileentity.TileEntityFourArc;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class ContainerFourArc extends Container
{
	private TileEntityFourArc tileFurnace;
	private int lastCookTime;
	private int lastBurnTime;

	public ContainerFourArc(InventoryPlayer par1InventoryPlayer, TileEntityFourArc par2TileEntityFurnace)
	{
	...
	public void addCraftingToCrafters(ICrafting par1ICrafting)
	{
		...
		par1ICrafting.sendProgressBarUpdate(this, 1, this.tileFurnace.power);
	}
	...
	public void detectAndSendChanges()
	{
		...
		for (int i = 0; i < this.crafters.size(); ++i)
		{
			...
			if (this.lastBurnTime != this.tileFurnace.power)
			{
				icrafting.sendProgressBarUpdate(this, 1, this.tileFurnace.power);
			}
		}

		this.lastCookTime = this.tileFurnace.cookTime;
		this.lastBurnTime = this.tileFurnace.power;
	}
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
	{
		...
		if (slot != null && slot.getHasStack())
		{
			...
			{
                if(FourArcRecipes.smelting().getSmeltingResult(itemstack1) != null){
                    if(!this.mergeItemStack(itemstack1, 0, 1, false)){
                        return null;
                    }
                }
				else if (TileEntityFourArc.isItemFuel(itemstack1))
				{
