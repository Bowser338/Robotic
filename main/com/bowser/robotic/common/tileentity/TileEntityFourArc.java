...
import cpw.mods.fml.relauncher.SideOnly;
	...
	public class TileEntityFourArc extends TileEntity implements ISidedInventory
	{
		...
		*/
    	...
    	/**
     	* Returns the name of the inventory. NOM DU FOUR
     	*/
    	public String getInvName()
    	{
        	return this.isInvNameLocalized() ? this.field_94130_e : "Four a Arc";
    	}
    	...
    	public static int getItemPower(ItemStack itemstack){
        	if (itemstack == null){
        		...
        		if (i == Robotic.battery) return 10;
            	if (i == Items.redstone) return 100;
            	if (i == Robotic.suBattery) return 10;
            	return 0;
