...
public class TileEntityFourArc extends TileEntity implements ISidedInventory
{
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.furnaceName : "ARC Furnace";
    }
    ...
    public void updateEntity() {
        ...
        if (flag != this.furnaceBurnTime > 0) {
            flag1 = true;
            FourArcBlock.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
        }
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            ...
            ItemStack itemstack = FourArcRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public static int getItemBurnTime(ItemStack itemstack){
        if(itemstack == null){
            ...
            if(item == Robotic.lithiumDust) return 1600;
